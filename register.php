...
echo "Invalid marks";
   ...
   $name=$_POST['name'];
    ...
    $s="INSERT INTO totalmarks(MarksPhy,MarksChem,MarksMath,Total) VALUES ('$phy','$chem','$math','$total')";
    $sq="INSERT INTO rankallotment(RegNo, Total, MarksPhy, MarksChem, MarksMath) VALUES ('$id','$total','$phy','$chem','$math')";
